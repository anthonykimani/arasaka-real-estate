const PropertyCard = ({
  ...
  return (
    <div className="flex flex-col md:flex-row md:max-w-[800px] md:w-[100%] bg-white md:max-h-[400px] font-jost text-gray-900 rounded-lg shadow-lg">
      <div className="md:max-w-[300px] w-[100%]">
        <img
          src={process.env.PUBLIC_URL + img}
          alt=""
          className="object-cover max-w-[800px] w-[100%] md:max-w-[300px]  max-h-[300px] rounded-t-md md:rounded-l-md md:rounded-t-none"
        />
      </div>
