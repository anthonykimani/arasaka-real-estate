            ...
            <div className="flex flex-col justify-around md:h-[500px]">
              <div className="border-2 flex justify-between max-w-[470px] w-[100%] rounded-xl py-3 px-5 m-3">
                <div>
                  ...
                  <h3 className="font-open font-light text-xl">Hello {user.first_name}</h3>
                </div>
                <div className="">
              ...
              <div className="flex justify-between items-center p-2">
                ...
                <div>
                  <button onClick={handlePurchase} className="focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 text-sm font-bold leading-none text-white focus:outline-none bg-blue-500 border rounded hover:bg-blue-600 py-3 px-5 w-full font-open " disabled={disabled} >
                    Pay {cartItem.price}
                  </button>
                  <h3 style={isLoggedIn?{display:"none"}:{display:"block"}}>please log in first before purchase</h3>
                </div>
              </div>
            </div>
          </div>
